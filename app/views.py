...
def about():
    ...
    return render_template('about.html', name="Abygayle Ivey")
...
def propertyy():
    ...
    if request.method == 'POST' and form.validate_on_submit():
        ...
        property_info = PropertyInfo(title, num_bedrooms, num_bathrooms, location, price, typeHA, description, filename)
...
def propertyid(propertyid):
    ...
    if request.method == 'GET':
        return render_template('property_in.html', properties = proprecord)
